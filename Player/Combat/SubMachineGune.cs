...
{
    public class SubMachineGune : MonoBehaviour
    {
        ...
        // private void GetBarrelDirection()
        // {
        //     //Check to see if there is anything to shoot at and direct our bullets towards it
        //     if (Physics.Raycast(barrelLocation.position, barrelLocation.forward, out var hit, 50f))
        //     {
        //         if (Vector3.Distance(barrelLocation.position, hit.point) > 1f)
        //         {
        ...
        //     else
        //     {
        //         barrelLocation.LookAt(barrelLocation.position + (barrelLocation.forward * 30));
        //     }
        // }
